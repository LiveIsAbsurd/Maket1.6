...
let modalFeedbackOpenButton = document.querySelectorAll('.button--icon-feedback');
let modalFeedbackCloseButton = modalFeedback.querySelector('.modal__close-button');
...
let buttonClickFeedback = function (item) {
  item.addEventListener('click', function () {
    ...
    modalFeedbackCloseButton.classList.add('modal-feedback__close-button--open');
  })
}
